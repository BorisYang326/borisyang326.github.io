...
\section{\textsc{Education (in chronological order)}}
  ...
  \resumeSubheading
    ...
    \resumeSubheading
      {The Hong Kong University of Science and Technology}{Feb. 2026 (Expected)}
...
\section{Research Interests}
    %\resumeSubHeadingListStart
    \qquad Unified Multimodal Model; CoT in Visual Generation; Graphic Design Generation; Creative AI
    %\resumeSubHeadingListEnd
    \vspace{-6pt}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {\href{https://c4g-hkust.github.io/}{C4 Group}, HKUST}{Aug. 2025 -- Present}
      {Research Assistant , Supervised by \href{https://whluo.github.io/}{Prof.Wenhan Luo}}{Hong Kong, China}
      \resumeItemListStart
        \resumeItem{Exploring Chain-of-Thought reasoning in visual generation and its applications on unified multimodal models.}
      \resumeItemListEnd
