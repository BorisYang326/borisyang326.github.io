...
% \begin{center}
{\huge \textbf{Bo Yang (杨博)}} \\ \vspace{6pt}
\small  
...
% \href{mailto:borisyang326@gmail.com}{\raisebox{-0.2\height}\faEnvelope\  \underline{borisyang326@gmail.com}} ~ 
\href{mailto:bo.yang@connect.ust.hk}{\raisebox{-0.2\height}\faEnvelope\  \underline{bo.yang@connect.ust.hk}} ~ 
...
\section{\textsc{Education (in chronological order)}}
  ...
  \resumeSubheading
    ...
    \resumeSubheading
      {ShanghaiTech University}{Sep. 2022 -- Aug. 2025}
      {Master of Science in Computer Science, GPA 3.82/4.0}{Shanghai, China}
      \item \small{\textit{Advisor: \textbf{\href{https://www.ying-cao.com/}{Prof.Ying Cao}}}}
    
    \resumeSubheading
      {The Hong Kong University of Science and Technology}{Jan. 2026 -- Present}
      {Ph.D. Student in Arts and Machine Creativity}{Hong Kong, China}
      \item \small{\textit{Co-supervised by \textbf{\href{https://whluo.github.io/}{Prof.Wenhan Luo}} and \textbf{\href{https://hongbofu.people.ust.hk/}{Prof.Hongbo Fu}}}}
...
\section{Research Interests}
    %\resumeSubHeadingListStart
    \qquad  Graphic Design Generation; Unified Multimodal Model; Visual Latent CoT; Creative AI
    %\resumeSubHeadingListEnd
    \vspace{-6pt}
...
\section{Publications}
    \resumeItemListStart
      ...
      \vspace{2pt}
      Develop a method to learn a content-aware neural order, which can significantly improve graphic generation quality, generalize across different types of generative models and help design generators scale up greatly.
      }
    \resumeItemListEnd
\vspace{-6pt}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {\href{https://c4g-hkust.github.io/}{C4 Group}, HKUST}{Aug. 2025 -- Jan. 2026}
      {Research Assistant , Supervised by \href{https://whluo.github.io/}{Prof.Wenhan Luo}}{Hong Kong, China}
      \resumeItemListStart
        \resumeItem{Working on projects about visual latent CoT and multi-modal generation.}
      \resumeItemListEnd
...
\resumeItemListStart
\itemsep -0pt
\resumeItem{\textit{\textbf{Overseas Exchange Scholarship}}, ShanghaiTech University}\hfill{\textit{May 2019}}
...
\resumeItem{\textit{\textbf{Excellent Graduate}}, ShanghaiTech University}\hfill{\textit{Aug 2025}}
\resumeItemListEnd
\vspace{-6pt}
