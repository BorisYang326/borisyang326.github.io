...
\section{Research Projects}
    ...
    %   {Learning Element Ordering for Design Template Generation}{January 2023 -- Present}
    %       \resumeItemListStart
    %         \resumeItem{Proposed a novel training pipeline for coordinating learning element ordering within a design template generation task.}
    %         \resumeItem{Completed the first draft version and scheduled the submission for SIGGRAPH Asia 2024.}
    %       \resumeItemListEnd
    % \resumeSubHeadingListEnd
    \resumeSubHeadingListStart
    \resumeProjectHeadingLarge{Editable Vector Design Generation from Text}{Jul 2024 -- Mar 2025}
          \resumeItemListStart
            \resumeItem{Proposed an end-to-end framework for text-to-vector-design generation, including a novel dataset with authentic design intentions and a reliable evaluation metric}
            \resumeItem{Submitted to ICCV 2025, second author. }
          \resumeItemListEnd
    \resumeProjectHeadingLarge{Text-guided Saliency Prediction for Graphic Design}{Jul 2023 -- Jan 2024}
          \resumeItemListStart
            \resumeItem{Propose a weakly supervised learning method for predicting saliency maps on graphic designs using natural language supervision}
            \resumeItem{Submitted to ICCV 2025, third student author. }
          \resumeItemListEnd
